...
![](vasaloppet_analys_och_modeller_files/figure-markdown_github/skiiers_mora_15_min_intervals_all_years-1.png)
...
![](vasaloppet_analys_och_modeller_files/figure-markdown_github/skiiers_mora_15_min_intervals_all_start_groups_2016-1.png)
...
![](vasaloppet_analys_och_modeller_files/figure-markdown_github/clubs_2012-1.png)

![](vasaloppet_analys_och_modeller_files/figure-markdown_github/clubs_2013-1.png)

![](vasaloppet_analys_och_modeller_files/figure-markdown_github/clubs_2014-1.png)

![](vasaloppet_analys_och_modeller_files/figure-markdown_github/clubs_2015-1.png)

![](vasaloppet_analys_och_modeller_files/figure-markdown_github/clubs_2016-1.png)
...
![](vasaloppet_analys_och_modeller_files/figure-markdown_github/ageclasses_histogram_2016-1.png)
...
![](vasaloppet_analys_och_modeller_files/figure-markdown_github/ageclasses_gender_histogram_2016-1.png)
...
![](vasaloppet_analys_och_modeller_files/figure-markdown_github/ageclasses_avgmoratime_2016-1.png)
...
![](vasaloppet_analys_och_modeller_files/figure-markdown_github/ageclasses_gender_avgmoratime_2016-1.png)
...
![](vasaloppet_analys_och_modeller_files/figure-markdown_github/time_recommender_interval_plot-1.png)
...
6. Granskning av mellantidsrekommendationerna *(analys)*
--------------------------------------------------------

![](vasaloppet_analys_och_modeller_files/figure-markdown_github/plot_quantile_median_time_summary_smagan_vs_mora-1.png)

![](vasaloppet_analys_och_modeller_files/figure-markdown_github/plot_quantile_median_time_summary_hokberg_vs_mora-1.png)

![](vasaloppet_analys_och_modeller_files/figure-markdown_github/plot_skiier_number_of_intervals_checked-1.png)

![](vasaloppet_analys_och_modeller_files/figure-markdown_github/skiiers_deviation_from_75percent_intervals_all_years-1.png)

![](vasaloppet_analys_och_modeller_files/figure-markdown_github/skiiers_deviation_from_75percent_intervals_all_moratimegrps-1.png)

![](vasaloppet_analys_och_modeller_files/figure-markdown_github/skiiers_deviation_from_75percent_intervals_all_years_all_moratimegrps-1.png)

7. Hastigheter för skidåkare med liknande tid i mål *(analys)*
--------------------------------------------------------------
...
![](vasaloppet_analys_och_modeller_files/figure-markdown_github/avg_time_timegrpsmora_all_controls_2012-1.png)
...
![](vasaloppet_analys_och_modeller_files/figure-markdown_github/avg_time_timegrpsmora_all_controls_2016-1.png)
...
![](vasaloppet_analys_och_modeller_files/figure-markdown_github/avgpaces_mangsbodarna_to_risberg_all_years-1.png)

![](vasaloppet_analys_och_modeller_files/figure-markdown_github/avgpaces_eldris_to_mora_all_years-1.png)

![](vasaloppet_analys_och_modeller_files/figure-markdown_github/moratime_vs_all_controltimes_all_skiiers_all_years-1.png)

![](vasaloppet_analys_och_modeller_files/figure-markdown_github/moratime_vs_all_controltimes_all_skiiers_2015_2016-1.png) Kan alltså skilja ganska mycket från år till år vilka tider som skidåkarna kommit in till de olika kontrollerna. De skuggade områdena visar hur mycket av data som överlappar. Så exempelvis Mångsbodarna till Oxberg är det ganska stor andel data som inte överlappar. Detta beror säkert på att olika sträckor är olika svåråkta från år till år.

![](vasaloppet_analys_och_modeller_files/figure-markdown_github/moratimegrps_pane_plot_yearly_paces_compared_to_mean_all_years_2015-1.png)

![](vasaloppet_analys_och_modeller_files/figure-markdown_github/moratimegrps_pane_plot_yearly_paces_compared_to_mean_all_years_2016-1.png)
...
8. Hastighetsprofiler för skidåkare med liknande tid i mål *(avancerat)*
------------------------------------------------------------------------

![](vasaloppet_analys_och_modeller_files/figure-markdown_github/pca_example_plot1-1.png)

![](vasaloppet_analys_och_modeller_files/figure-markdown_github/pca_example_plot2-1.png)

![](vasaloppet_analys_och_modeller_files/figure-markdown_github/plot_PC1_comp_vs_time_gain_2016-1.png)

![](vasaloppet_analys_och_modeller_files/figure-markdown_github/plot_PC2_comp_vs_time_gain_2016-1.png)

![](vasaloppet_analys_och_modeller_files/figure-markdown_github/plot_PC3_comp_vs_time_gain_2016-1.png)

![](vasaloppet_analys_och_modeller_files/figure-markdown_github/model_contour_plot_over_PC1_PC2_components_2016-1.png)

![](vasaloppet_analys_och_modeller_files/figure-markdown_github/plot_PC1_PC2_loadings_and_preferred_pace_profile_2016-1.png)

![](vasaloppet_analys_och_modeller_files/figure-markdown_github/plot_principal_loadings_2016-1.png)
